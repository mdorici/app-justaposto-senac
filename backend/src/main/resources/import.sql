...
INSERT INTO tb_product (name, price, description, img_url) VALUES ('Lavagem detalhada', 200.0, ' Limpeza completa do veículo inclusive os cantos, carpetes, bancos, motor, rodas, etc.', '');
INSERT INTO tb_product (name, price, description, img_url) VALUES ('Película Solar Antivandalismo', 1450.0, 'Protege contra tentativas de quebra de vidros, tornando-os mais resistentes', '');
INSERT INTO tb_product (name, price, description, img_url) VALUES ('Nano Proteção', 968.0.0, 'Oferece camada extra de proteção à pintura do carro, resistente a riscos e intempéries', '');
INSERT INTO tb_product (name, price, description, img_url) VALUES ('PPF (Proteção de Pintura)', 1100.0, ' Película transparente aplicada sobre a pintura do carro, protegendo contra riscos e pedras', '');
INSERT INTO tb_product (name, price, description, img_url) VALUES ('Polimento', 150.0, 'Remove riscos, manchas e marcas de desgaste da pintura do carro', '');
