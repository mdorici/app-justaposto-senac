...
INSERT INTO tb_product (name, price, date, description, img_url) VALUES ('Cristalização de vidros', 1690.0, TIMESTAMP WITH TIME ZONE '2023-11-14T10:00:00Z', 'A cristalização de vidros é responsável por garantir mais segurança ao motorista, uma vez que a cristalização proporciona a impermeabilização do para-brisa do veículo. Com o serviço, os vidros ficam protegidos contra inúmeros fatores externos, como respingos, poeira, salinidade marinha e outras sujeiras que podem aderir à superfície. O resultado cria uma espécie de camada protetora e transparente.', 'https://github.com/mdorici/pi-iv-senac-app-justaposto/blob/main/documents/img/cristalizacao.jpg?raw=true');
